...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    public static double TICKS_PER_REV = 2000; // 2000 Countable Events per Revolution
    public static double WHEEL_RADIUS = 0.944882; // in (48 mm dia wheel from GoBuilda)
